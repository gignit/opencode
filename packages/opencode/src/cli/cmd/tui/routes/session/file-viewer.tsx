...
export function FileViewer(props: FileViewerProps) {
  ...
  // Virtual mode: close on discard (no file to view)
  createEffect(() => {
    if (isVirtual() && !editMode() && !loading()) {
      props.onClose()
    }
  })
  ...
  // Display title: virtual title or file path
  const displayTitle = () => {
    if (isVirtual() && props.virtualTitle) return props.virtualTitle
    return relativePath()
  }
